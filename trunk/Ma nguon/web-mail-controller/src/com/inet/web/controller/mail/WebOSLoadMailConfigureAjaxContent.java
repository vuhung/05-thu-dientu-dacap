...
import com.inet.web.service.mail.MailConfigureService;

public class WebOSLoadMailConfigureAjaxContent extends AbstractWebOSAjaxContentController<MailConfigureService> {
	
	/**
	 * WebOSMailConfigureTransactionAjaxContent constructor
	 * @param service
	 */
	public WebOSLoadMailConfigureAjaxContent(MailConfigureService service) {
		super(service);
	}
