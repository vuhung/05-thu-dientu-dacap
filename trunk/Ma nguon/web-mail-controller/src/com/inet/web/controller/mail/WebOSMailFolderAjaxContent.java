 ...
 * @version 1.0b
 */
public class WebOSMailFolderAjaxContent extends
								AbstractWebOSTxAjaxContentController<MailFolderService> {

	/**
	 * WebOSBuildMailFolderAjaxContent constructor
	 * @param service
	 */
	public WebOSMailFolderAjaxContent(MailFolderService service) {
		super(service);
	}
