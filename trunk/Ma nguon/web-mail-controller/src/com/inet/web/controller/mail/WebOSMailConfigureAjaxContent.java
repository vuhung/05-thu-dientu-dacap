...
public class WebOSMailConfigureAjaxContent extends AbstractWebOSTxAjaxContentController<MailConfigureService> {
	
	/**
	 * WebOSMailConfigureAjaxContent constructor
	 * @param service
	 */
	public WebOSMailConfigureAjaxContent(MailConfigureService service) {
		super(service);
	}
