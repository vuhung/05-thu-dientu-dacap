...
/**
 * WebOSMailFollowUpAjaxContent.
 * 
 * @author <a href="mailto:tntan@truthinet.com.vn"> Truong Ngoc Tan</a>
 * @version 1.0b
 */
public class WebOSMailFollowUpAjaxContent extends AbstractWebOSTxAjaxContentController<FollowUpService> {

	/**
	 * WebOSMailFollowUpContent constructor
	 * @param service
	 */
	public WebOSMailFollowUpAjaxContent(FollowUpService service) {
		super(service);
	}
