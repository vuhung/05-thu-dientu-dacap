...
import com.inet.web.service.mail.MailFolderService;

/**
 * WebOSLoadMailFolderAjaxContent.
 * 
 * @author <a href="mailto:tntan@truthinet.com"> Truong Ngoc Tan</a>
 * @version 1.0b
 */
public class WebOSLoadMailFolderAjaxContent extends
								AbstractWebOSAjaxContentController<MailFolderService> {

	/**
	 * WebOSBuildMailFolderAjaxContent constructor
	 * @param service
	 */
	public WebOSLoadMailFolderAjaxContent(MailFolderService service) {
		super(service);
	}
