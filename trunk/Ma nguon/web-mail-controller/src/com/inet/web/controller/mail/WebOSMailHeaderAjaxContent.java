...
/**
 * WebOSMailHeaderAjaxContent.
 * 
 * @author <a href="mailto:tntan@truthinet.com"> Truong Ngoc Tan</a>
 * @version 1.0b
 */
public class WebOSMailHeaderAjaxContent extends
								AbstractWebOSTxAjaxContentController<MailHeaderService> {

	public WebOSMailHeaderAjaxContent(MailHeaderService service) {
		super(service);
	}
