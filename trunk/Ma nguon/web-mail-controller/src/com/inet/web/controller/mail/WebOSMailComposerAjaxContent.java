...
import com.inet.web.service.mail.MailComposerService;

/**
 * WebOSMailComposerAjaxContent.
 * 
 * @author <a href="mailto:tntan@truthinet.com"> Truong Ngoc Tan</a>
 * @version 1.0b
 */
public class WebOSMailComposerAjaxContent extends AbstractWebOSTxAjaxContentController<MailComposerService> {
	
	/**
	 * WebOSMailComposerAjaxContent constructor
	 * @param service
	 */
	public WebOSMailComposerAjaxContent(MailComposerService service) {
		super(service);
	}
