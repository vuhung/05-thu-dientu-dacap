...
/**
 * @class iNet.iwebos.ui.account.DialogSearchAccount
 * @extends Ext.Window
 * @constructor
 ...
 * @param {Object} config
 */
iNet.iwebos.ui.account.DialogSearchAccount = function(viewer, config){
    this.viewer = viewer;
    ...
    iNet.iwebos.ui.account.DialogSearchAccount.superclass.constructor.call(this, {
...
Ext.extend(iNet.iwebos.ui.account.DialogSearchAccount, iNet.iwebos.ui.common.dialog.TitleDialog, {
    /**
     * no border.
     */
    bodyBorder: false,
