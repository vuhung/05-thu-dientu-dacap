...
import com.inet.web.service.mail.SearchMailAsAccountService;

/**
 * SearchMailAsAccountAjaxContent.
 * 
 * @author <a href="mailto:tttduyen@truthinet.com">Duyen Tang</a>
 * @version 0.2i
 */
public class SearchMailAsAccountAjaxContent extends 
		AbstractWebOSAjaxContentController<SearchMailAsAccountService> {

	/**
	 * Create <tt>SearchMailAsAccountAjaxContent</tt> instance
	 * 
	 * @param service SearchMailAsAccountService - the search mail as account service
	 */
	public SearchMailAsAccountAjaxContent(SearchMailAsAccountService service) {
		super(service);
	}
