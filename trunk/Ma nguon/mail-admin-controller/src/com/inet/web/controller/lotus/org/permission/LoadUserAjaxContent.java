...
import com.inet.web.service.lotus.org.permission.LoadUserService;
 ...
 * @version 0.2i
 */
public class LoadUserAjaxContent extends AbstractWebOSAjaxContentController<LoadUserService> {

	/**
	 * The constructor
	 * 
	 * @param service LoadUserService - the user service
	 */
	public LoadUserAjaxContent(LoadUserService service) {
		super(service);
	}
