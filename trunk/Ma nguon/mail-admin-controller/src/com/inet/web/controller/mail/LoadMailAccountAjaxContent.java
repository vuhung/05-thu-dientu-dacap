...
import com.inet.web.service.mail.LoadMailAccountService;

/**
 * LoadMailAccountAjaxContent.
 * 
 * @author <a href="mailto:tttduyen@truthinet.com">Duyen Tang</a>
 * @version 0.2i
 */
public class LoadMailAccountAjaxContent extends
		AbstractWebOSAjaxContentController<LoadMailAccountService> {

	/**
	 * The constructor
	 * 
	 * @param loadMailAccountService LoadMailAccountService - the load mail account service
	 */
	public LoadMailAccountAjaxContent(LoadMailAccountService loadMailAccountService) {
		super(loadMailAccountService);
	}
