...
*****************************************************************/
package com.inet.web.controller.mail.permission;
...
import com.inet.web.service.mail.permission.LoadPermissionService;
 ...
 * @version 0.2i
 */
public class LoadPermissionContent extends AbstractWebOSAjaxContentController<LoadPermissionService> {
	
	/**
	 * @param loafPermissionService
	 */
	public LoadPermissionContent(LoadPermissionService loafPermissionService) {
		super(loafPermissionService);
	}
