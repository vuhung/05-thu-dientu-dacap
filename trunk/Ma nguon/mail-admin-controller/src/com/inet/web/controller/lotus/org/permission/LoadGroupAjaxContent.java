...
import com.inet.web.service.lotus.org.permission.LoadGroupService;

/**
 * LoadGroupAjaxContent.
 * 
 * @author <a href="mailto:tttduyen@truthinet.com">Duyen Tang</a>
 * @version 0.2i
 */
public class LoadGroupAjaxContent extends AbstractWebOSAjaxContentController<LoadGroupService> {

	/**
	 * The constructor
	 * 
	 * @param service LoadGroupService - the group service
	 */
	public LoadGroupAjaxContent(LoadGroupService service) {
		super(service);
	}
