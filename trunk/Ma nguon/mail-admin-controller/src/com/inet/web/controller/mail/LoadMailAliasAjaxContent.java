...
import com.inet.web.service.mail.LoadMailAliasService;

/**
 * LoadMailAliasAjaxContent.
 * 
 * @author <a href="mailto:tttduyen@truthinet.com">Duyen Tang</a>
 * @version 0.2i
 */
public class LoadMailAliasAjaxContent extends
		AbstractWebOSAjaxContentController<LoadMailAliasService> {

	/**
	 * The constructor
	 * 
	 * @param loadMailAliasService LoadMailAliasService - the load mail alias service
	 */
	public LoadMailAliasAjaxContent(LoadMailAliasService loadMailAliasService) {
		super(loadMailAliasService);
	}
