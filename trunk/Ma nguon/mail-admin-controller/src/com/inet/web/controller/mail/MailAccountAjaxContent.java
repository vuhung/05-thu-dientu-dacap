...
import com.inet.web.service.mail.MailAccountService;

/**
 * MailAccountAjaxContent.
 * 
 * @author <a href="mailto:tttduyen@truthinet.com">Duyen Tang</a>
 * @version 0.2i
 */
public class MailAccountAjaxContent extends AbstractWebOSAjaxContentController<MailAccountService> {

	/**
	 * The constructor
	 * 
	 * @param mailAccountService MailAccountService - the mail account service
	 */
	public MailAccountAjaxContent(MailAccountService mailAccountService) {
