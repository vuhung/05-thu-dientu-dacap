...
import com.inet.web.service.lotus.org.permission.GroupService;
 ...
 * @version 0.2i
 */
public class GroupAjaxContent extends AbstractWebOSAjaxContentController<GroupService> {

	/**
	 * The constructor
	 * 
	 * @param service GroupService - the group service
	 */
	public GroupAjaxContent(GroupService service) {
		super(service);
	}
