...
import com.inet.web.service.lotus.account.LoadAccountService;
 ...
 * @version 0.2i
 */
public class LoadAccountAjaxContent extends AbstractWebOSAjaxContentController<LoadAccountService> {

	/**
	 * Create <tt>LoadAccountContent</tt> instance
	 * 
	 * @param loadAccountService LoadAccountService - the load account service
	 */
	protected LoadAccountAjaxContent(LoadAccountService loadAccountService) {
		super(loadAccountService);
	}
