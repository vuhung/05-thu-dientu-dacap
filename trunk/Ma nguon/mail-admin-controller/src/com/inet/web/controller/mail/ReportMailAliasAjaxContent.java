...
import com.inet.web.service.mail.ReportMailAliasService;

/**
 * ReportMailAliasAjaxContent.
 * 
 * @author <a href="mailto:tttduyen@truthinet.com">Duyen Tang</a>
 * @version 0.2i
 */
public class ReportMailAliasAjaxContent extends AbstractWebOSAjaxContentController<ReportMailAliasService> {

	/**
	 * Create <tt>ReportMailAliasAjaxContent</tt> instance
	 * 
	 * @param service ReportMailAliasService - the service
	 */
	public ReportMailAliasAjaxContent(ReportMailAliasService service) {
		super(service);
	}
