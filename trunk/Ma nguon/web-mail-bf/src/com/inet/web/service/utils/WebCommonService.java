...
public abstract class WebCommonService {
	 ...
	 * </pre>
	 * 
	 * @param strID String - the given list of identifier representing as string.
	...
	/**
	 * Get data as long from the given request and parameter.
	 * 
	 * @param request HttpServletRequest - the given request.
	 * @param param String - the given request.
	 * @param dValue long - the given default value.
	 * @return the value.
	 */
	public static long toLong(HttpServletRequest request, String param, long dValue) {
		// get parameter value.
		String value = request.getParameter(param) ;

		try {			
			if(!StringService.hasLength(value)) return dValue ;
			return Long.parseLong(value) ;
		}catch(Exception ex) {
			logger.warning("could not content [" + value + "] to long.", ex) ;
		}
	 ...
	 * @param format String - the given date format.
	...
	/**
	 * @return the JSON object fromt he given request and parameter.
	 */
