 ...
 * @date May 7, 2008
 * <pre>
 *  Initialization DoesNotContainFilter class.
 * </pre>
 */
public class DoesNotContainFilter extends CompareFilter {

	/**
	 * Create DoesNotContainFilter instance from the given filter clause.
	 * 
	 * @param filterClause MailFilterClauseUnit - the given filter clause.
	 */
	public DoesNotContainFilter(MailFilterClauseUnit filterClause) {
		super(filterClause);
	}
	...
	protected boolean performCompare(String data) {
		if(!FilterOperator.DOES_NOT_CONTAIN.equals(this.getFilterClause().getOperator())) return false ;
