 ...
 * @date May 7, 2008
 * <pre>
 *  Initialization DateSentFilterObject class.
 * </pre>
 */
public class DateSentFilterObject extends AbstractFilterObject {
	...
	public String getData(MailHeader header) {
		/**
		 * return the date when mail sent.
		 */
		return (header != null ? 
					DateService.format(header.getSent(), DateService.VIETNAM_DATE_PATTERN) : 
