 ...
 * @version $Id: PopBeanDefinition.java Dec 7, 2008 nguyen_dv $
 * 
 * Create date: Dec 7, 2008
 * <pre>
 *  Initialization PopBeanDefinition class.
 * </pre>
 */
public class PopBeanDefinition extends AbstractBeanDefinition {
	//~ Static fields =========================================================
	/* POP definition bean name. */
	public static final String POP_BEAN_DEFINITION_NAME = PopBeanDefinition.class.getName() ;
	...
	public String getName() {
		return POP_BEAN_DEFINITION_NAME;
	}
