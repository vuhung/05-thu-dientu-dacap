 ...
 * @date Feb 1, 2008
 * <pre>
 *  Initialization DataSSLSocketFactory class.
 * </pre>
 */
public class DataSSLSocketFactory extends SSLSocketFactory {
	/**
	 * Class name.
	 */
	public static final String CLASSNAME = "com.inet.mail.security.DataSSLSocketFactory" ;
	 ...
	 */
	public DataSSLSocketFactory(){
		try{
			this.socketFactory = AbstractSecureProtocolSocketFactory.getInstance(SecureService.SSL) ;
		}catch(RuntimeException brex){
			// throw exception.
			System.err.println("*****ERROR [" + DataSSLSocketFactory.class.getSimpleName() + "] " + brex.getMessage()) ;
		}
	}
