...
*****************************************************************/
package com.inet.web.service.support.springsecurity;
...
public class AccountCacheLogoutHandler implements LogoutHandler {
	...
	public void logout(HttpServletRequest request, HttpServletResponse response,
		...
		if(authentication != null){
			...
			if(authentication instanceof PrincipalSpringSecurityUserToken){
				username = ((PrincipalSpringSecurityUserToken)authentication).getName() ;
			...
			try{
				if(StringService.hasLength(username)) UserCacheService.remove(username) ;
			}catch(Exception ex){
