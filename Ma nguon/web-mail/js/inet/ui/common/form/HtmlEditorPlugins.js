/*
   Copyright 2009-2010 by Nguyen Thanh Vy (ntvy@truthinet.com.vn)
...
*/
/**
 * @class iNet.iwebos.ui.common.form.HtmlEditorPlugins
 */

/**
 * @class iNet.iwebos.ui.common.form.HtmlEditorPlugins.Table
 * @extends Ext.util.Observable
 * <p>A plugin that creates a button on the HtmlEditor for making simple tables.</p>
 */
iNet.iwebos.ui.common.form.HtmlEditorPlugins.Table = Ext.extend(Ext.util.Observable, {
    // Table language text
    langTitle       : iwebos.message.mail.table_title,
    langInsert      : iwebos.message.mail.table_insert,
    langCancel      : Ext.MessageBox.buttonText.cancel,
    langRows        : iwebos.message.mail.table_rows,
    langColumns     : iwebos.message.mail.table_colum,
    langBorder      : iwebos.message.mail.table_border,
    langCellLabel   : iwebos.message.mail.table_cell_label,
    // private
    cmd: 'table',
    /**
     ...
     */
    tableBorderOptions: [['1px solid #000', 'Sold Thin'], ['2px solid #000', 'Solid Thick'], ['1px dashed #000', 'Dashed'], ['1px dotted #000', 'Dotted'],['none', 'None']],
    // private
    init: function(cmp){
        this.cmp = cmp;
