...
<html xmlns="http://www.w3c.org/1999/xhtml">
	...
	<body>
		...
		<div id="loading">
		    <div class="loading-indicator"><img src="images/ics16/iwebos.gif" width="36" height="36" style="margin-right:8px;float:left;vertical-align:top;"/>iMail - <a href="http://www.truthinet.com.vn/home/mail/welcome.iws">iMail Server 2010</a><br/><span id="loading-msg">Loading styles and images...</span></div>
		</div>	
		...
		<script type="text/javascript">document.getElementById('loading-msg').innerHTML = 'Loading iNet resources...';</script>
		<script type="text/javascript" src="js/ext/resources/ext-lang-vn.js"></script>
		...
		<script type="text/javascript">
			try {
				var pageTracker = _gat._getTracker("UA-4844460-3");
