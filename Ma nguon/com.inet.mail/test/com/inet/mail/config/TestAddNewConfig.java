...
public class TestAddNewConfig extends AbstractConfigureTestMail{

	public void testAddNew() throws Exception{
		MailReceiverObject receiverObject = new MailReceiverObject("");
		receiverObject.setAccountName("tntan@truthinet.com.vn");
		receiverObject.setAccountPassword(MailService.encrypt("tntan@truthinet.com.vn", "tntan"));
		...
		receiverObject.setSMTPAccountPassword(MailService.encrypt("tntan@truthinet.com.vn", "tntan"));
