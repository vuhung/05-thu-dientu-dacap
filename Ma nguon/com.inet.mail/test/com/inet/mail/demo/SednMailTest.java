...
public class SednMailTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			MessageComposer composer = IOService.getObject(mailMF.getBody("15"), MessageComposer.class);
			composer.addTo("Hien Nguyen<hiennguyen@truthinet.com.vn>");
			//composer.addCc("Hien Nguyen<hien_joe@yahoo.com>");
			composer.setBodyText("// TODO Auto-generated catch block");
			byte[] attach = IOService.readToBytes(new File("C:\\Documents and Settings\\hiennguyenvan\\Desktop\\ten_myths.pdf"));
			composer.addAttachment("hing-hien.pdf", attach);
			mailMF.sendMessage(composer, 13);
		} catch (NamingException e) {
