 ...
 * @version $Id: LongLiveCacheHelper.java 2008-12-10 10:22:32Z nguyen_dv $
 * 
...
public abstract class LongLiveRegionHelper {
	 ...
	 * 
	 * @return {@link RegionManager} instance.
	...
	protected static RegionManager getCache() throws CacheSupportException{
		...
		// return the cache.
		return RegionManagerSupport.getInstance(context.getContext(), LONG_LIVE_REGION) ;
	}	
}
