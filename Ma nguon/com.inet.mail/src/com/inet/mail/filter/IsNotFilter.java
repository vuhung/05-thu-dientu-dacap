 ...
 * @date May 7, 2008
 * <pre>
 *  Initialization IsNotFilter class.
 * </pre>
 */
public class IsNotFilter extends CompareFilter {

	/**
	 * Create IsNotFilter instance from the given filter clause.
	 * 
	 * @param filterClause MailFilterClauseUnit - the given filter clause.
	 */
	public IsNotFilter(MailFilterClauseUnit filterClause) {
		super(filterClause);
	}
	...
	protected boolean performCompare(String data) {
		if(!FilterOperator.IS_NOT.equals(this.getFilterClause().getOperator())) return false ;
