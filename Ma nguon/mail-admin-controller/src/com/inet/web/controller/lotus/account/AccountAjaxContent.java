...
import com.inet.web.service.lotus.account.AccountService;
 ...
 * @version 0.2i
 */
public class AccountAjaxContent extends AbstractWebOSAjaxContentController<AccountService> {

	/**
	 * @param accountService
	 */
	public AccountAjaxContent(AccountService accountService) {
