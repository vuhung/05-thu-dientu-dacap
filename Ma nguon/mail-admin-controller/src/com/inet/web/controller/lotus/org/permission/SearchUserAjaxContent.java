...
*****************************************************************/
package com.inet.web.controller.lotus.org.permission;
...
import com.inet.web.service.lotus.org.permission.SearchUserService;

/**
 * SearchUserAjaxContent.
 * 
 * @author <a href="mailto:tttduyen@truthinet.com">Duyen Tang</a>
 * @version 0.2i
 */
public class SearchUserAjaxContent extends
		AbstractWebOSAjaxContentController<SearchUserService> {

	/**
	 * The constructor
	 * 
	 * @param service SearchUserService - the search user service
	 */
	public SearchUserAjaxContent(SearchUserService service) {
		super(service);
	}
