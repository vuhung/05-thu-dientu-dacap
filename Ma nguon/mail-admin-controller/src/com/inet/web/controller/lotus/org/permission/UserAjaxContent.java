...
import com.inet.web.service.lotus.org.permission.UserService;
 ...
 * @version 0.2i
 */
public class UserAjaxContent extends AbstractWebOSAjaxContentController<UserService> {
	 ...
	 */
	protected UserAjaxContent(UserService userService) {
		super(userService);
	}
