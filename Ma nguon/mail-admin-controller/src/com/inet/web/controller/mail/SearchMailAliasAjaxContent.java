...
import com.inet.web.service.mail.SearchMailAliasService;

/**
 * SearchMailAliasAjaxContent.
 * 
 * @author <a href="mailto:tttduyen@truthinet.com">Duyen Tang</a>
 * @version 0.2i
 */
public class SearchMailAliasAjaxContent extends
		AbstractWebOSAjaxContentController<SearchMailAliasService> {

	/**
	 * The constructor
	 * 
	 * @param service SearchMailAliasService - the search mail alias service
	 */
	public SearchMailAliasAjaxContent(SearchMailAliasService searchMailAliasService) {
		super(searchMailAliasService);
	}
