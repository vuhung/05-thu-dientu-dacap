...
import com.inet.web.service.mail.domain.MailDomainService;

/**
 * MailDomainAjsxContent.
 * 
 * @author <a href="mailto:tttduyen@truthinet.com">Duyen Tang</a>
 * @version 0.2i
 */
public class MailDomainAjaxContent extends AbstractWebOSAjaxContentController<MailDomainService> {

	/**
	 * The constructor
	 * 
	 * @param mailDomainService MailDomainService - the mail domain service
	 */
	public MailDomainAjaxContent(MailDomainService mailDomainService) {
		super(mailDomainService);
	}
