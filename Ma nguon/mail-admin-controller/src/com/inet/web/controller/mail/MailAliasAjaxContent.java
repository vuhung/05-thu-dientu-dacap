...
import com.inet.web.service.mail.MailAliasService;

/**
 * MailAliasAjaxContent.
 * 
 * @author <a href="mailto:tttduyen@truthinet.com">Duyen Tang</a>
 * @version 0.2i
 */
public class MailAliasAjaxContent extends AbstractWebOSAjaxContentController<MailAliasService> {

	/**
	 * The constructor
	 * 
	 * @param mailAliasService MailAliasService - the mail alias service
	 */
	public MailAliasAjaxContent(MailAliasService mailAliasService) {
		super(mailAliasService);
	}
