...
/**
 * WebOSMailContentTransactionAjaxContent.
 * 
 * @author <a href="mailto:tntan@truthinet.com.vn"> Truong Ngoc Tan</a>
 * @version 1.0b
 */
public class WebOSLoadMailContentAjaxContent extends AbstractWebOSAjaxContentController<MailContentService> {
	/**
	 * WebOSMailContentTransactionAjaxContent constructor
	 * @param service
	 */
	public WebOSLoadMailContentAjaxContent(MailContentService service) {
		super(service);
	}
