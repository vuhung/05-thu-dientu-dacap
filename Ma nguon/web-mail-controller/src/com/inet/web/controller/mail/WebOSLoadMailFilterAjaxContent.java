...
import com.inet.web.service.mail.MailFilterService;

/**
 * WebOSMailFilterTransactionAjaxContent.
 * 
 * @author <a href="mailto:tntan@truthinet.com.vn"> Truong Ngoc Tan</a>
 * @version 1.0b
 */
public class WebOSLoadMailFilterAjaxContent  extends AbstractWebOSAjaxContentController<MailFilterService> {
	/**
	 * WebOSMailFilterTransactionAjaxContent constructor
	 * @param service
	 */
	public WebOSLoadMailFilterAjaxContent(MailFilterService service) {
		super(service);
	}
