...
import com.inet.web.service.mail.MailHeaderService;

public class WebOSLoadMailHeaderAjaxContent extends
								AbstractWebOSAjaxContentController<MailHeaderService> {
	/**
	 * WebOSMailHeaderTransactionAjaxContent constructor
	 * @param service
	 */
	public WebOSLoadMailHeaderAjaxContent(MailHeaderService service) {
		super(service);
	}
