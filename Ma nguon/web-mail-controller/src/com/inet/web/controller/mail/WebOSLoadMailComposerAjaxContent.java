...
public class WebOSLoadMailComposerAjaxContent extends AbstractWebOSAjaxContentController<MailComposerService> {
	
	/**
	 * WebOSMailComposerAjaxContent constructor
	 * @param service
	 */
	public WebOSLoadMailComposerAjaxContent(MailComposerService service) {
		super(service);
	}
