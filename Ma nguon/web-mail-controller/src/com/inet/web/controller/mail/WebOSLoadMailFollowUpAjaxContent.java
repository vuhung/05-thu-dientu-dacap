...
import com.inet.web.service.mail.FollowUpService;

/**
 * WebOSLoadMailFollowUpAjaxContent.
 * 
 * @author <a href="mailto:tntan@truthinet.com.vn"> Truong Ngoc Tan</a>
 * @version 1.0b
 */
public class WebOSLoadMailFollowUpAjaxContent extends AbstractWebOSAjaxContentController<FollowUpService> {

	/**
	 * WebOSLoadMailFollowUpContent constructor
	 * @param service
	 */
	public WebOSLoadMailFollowUpAjaxContent(FollowUpService service) {
		super(service);
	}
