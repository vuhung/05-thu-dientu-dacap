...
/**
 * WebOSMailFilterAjaxContent.
 * 
 * @author <a href="mailto:tntan@truthinet.com"> Truong Ngoc Tan</a>
 * @version 1.0b
 */
public class WebOSMailFilterAjaxContent  extends AbstractWebOSTxAjaxContentController<MailFilterService> {

	/**
	 * WebOSMailFilterAjaxContent constructor
	 * @param service
	 */
	public WebOSMailFilterAjaxContent(MailFilterService service) {
		super(service);
	}
